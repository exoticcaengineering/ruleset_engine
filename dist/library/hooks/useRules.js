...
const useRules = (url, discountUuid, discountName) => {
    ...
    const addRule = (newRule) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        console.log(payload);
        const res = yield axios.post(`${url}/${rulesetUuid || '1234-5678'}`, payload);
        console.log(res);
    ...
    useEffect(() => {
        const fetchRuleset = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const { data } = yield axios.get(`${url}?discountUuid=${discountUuid}`, options);
